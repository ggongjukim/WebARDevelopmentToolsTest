...
class Reticle extends THREE.Object3D {
  constructor() {
    ...
    this.loader.load("../reticle2D.glb", (gltf) => {
      // gltf.scene.set.scale(0.002,0.002,0.002);
      this.add(gltf.scene);
    })
...
// window.gltfLoader.load("../greenmodel.glb", function(gltf) {
...
window.DemoUtils = {
  ...
  createLitScene() {
    ...
    // for the shadow.
    const light = new THREE.HemisphereLight(0xbbbbff, 0x444422);//new THREE.AmbientLight(0xffffff, 1);
    const directionalLight =  new THREE.DirectionalLight(0xFFFFFF, 1);//new THREE.DirectionalLight(0xffffff, 0.3);
    directionalLight.position.set(0, 10, 0);//set(10, 15, 10);
    ...
    planeGeometry.rotateX(Math.PI / 2);//(-Math.PI / 2);
